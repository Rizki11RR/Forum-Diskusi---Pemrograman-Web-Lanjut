...
<div class="container-field">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <?php if($_SESSION['login_id'] == $_GET['id']): ?>
                <div class="dropleft float-right mr-4">
                    ...
                    <a class="dropdown-item edit_topic" data-id="<?php echo $id ?>"
                            href="javascript:void(0)">Edit</a>
                        <a class="dropdown-item delete_topic" data-id="<?php echo $id ?>"
                            href="javascript:void(0)">Delete</a>
                    </div>
                </div>
                <?php endif; ?>
                <span
                    class="float-right mr-4"><small><i><?php echo date('M d, Y h:i A',strtotime($date_created)) ?></i></small></span>
                <span class="float-right mr-4 text-primary"><small><i>Posted By:
                            <?php echo ucwords($name) ?></i></small></span>
                <div class="col-md-8">
                ...
                <div class="w-100">
                    ...
                    <span class="badge badge-primary text-white ml-2"><i class="fa fa-comments"></i>
                        <?php echo number_format(count($com_arr)) ?> comment/s</span>
                </div>
    			...
    			?>
                    <div class="form-group comment">
                        ...
                        <div class="dropleft float-right">
                            <a class="text-dark" href="javascript:void(0)" id="dropdownMenuButton"
                        ...
                        <?php endif; ?>
                        <span class="float-right mr-4"><small><i>Created:
                                    <?php echo date('M d, Y h:i A',strtotime($row['date_created'])) ?></i></small></span>

                        <p class="mb-0">
                            <large><b><?php echo $row['name'] ?></b></large> <span class="text-primary"><small
                                    class="mb-0"><i><?php echo $row['username'] ?></i></small></span>
                        </p>

                        <br>
                        <?php echo html_entity_decode($row['comment']) ?>
                        <div>
                            <span><button class="btn btn-default btn-sm c_reply" data-id='<?php echo $row['id'] ?>'><i
                                        class="fa fa-reply"></i></button></span>
                            <span
                                class="text-primary ml-4"><?php echo isset($rep_arr[$row['id']]) ? count($rep_arr[$row['id']]).(count($rep_arr[$row['id']]) > 1? ' Replies':' Replied') : '' ?></span>
    						...
    						?>
                                <div class="form-group ty-compact-list">
                                    ...
                                    <div class="dropleft float-right">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item edit_reply" data-id="<?php echo $rep['id'] ?>"
                                                href="javascript:void(0)">Edit</a>
                                            <a class="dropdown-item delete_reply" data-id="<?php echo $rep['id'] ?>"
                                                href="javascript:void(0)">Delete</a>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                    <span class="float-right mr-4"><small><i>Created:
                                                <?php echo date('M d, Y h:i A',strtotime($rep['date_created'])) ?></i></small></span>

                                    <p class="mb-0">
                                        <large><b><?php echo $rep['name'] ?></b></large> <span
                                            class="text-primary"><small
                                                class="mb-0"><i><?php echo $rep['username'] ?></i></small></span>
                                    </p>
                ...
                <div class="col-lg-12">
                    <form action="" id="manage-comment">
                        <div class="form-group">
                            ...
                            <textarea class="form-control jqte" id="comment-txt" name="comment" cols="30" rows="5"
